...
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -13.53  // Z offset: -below +above  [the nozzle] // daq  Caliper difference of 0.03 on the center output (G30 reads 13.75, G29 4x4 reads -0.01)
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -13.28  // Z offset: -below +above  [the nozzle] // daq  Caliper difference of 0.03 on the center output (G30 reads 13.75, G29 4x4 reads -0.01)
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -13.9  // Z offset: -below +above  [the nozzle] // daq  Caliper difference of 0.03 on the center output (G30 reads 13.75, G29 4x4 reads -0.01)
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -14.05  // Z offset: -below +above  [the nozzle] // daq  Caliper difference of 0.03 on the center output (G30 reads 13.75, G29 4x4 reads -0.01)
